    ...
    <div style={{ gridColumn: "1/-1", marginBottom: "13px" }} ref={ref}>
      ...
      <div style={{ position: "relative" }}>
        ...
        {open && results.length > 0 && (
          <div style={{ position: "absolute", zIndex: 300, top: "calc(100% + 5px)", left: 0, right: 0, background: "#fff", border: "1px solid #e2e8f0", borderRadius: "12px", boxShadow: "0 4px 6px -1px rgba(0,0,0,0.07), 0 10px 20px -5px rgba(0,0,0,0.05)", maxHeight: "300px", overflowY: "auto" }}>
            {results.map((r, i) => {
              const siege = r.siege || {};
      ...
      {error && <div style={{ marginTop: "5px", fontSize: "11.5px", color: "#dc2626", display: "flex", alignItems: "center", gap: "5px" }}><Icon name="AlertCircle" size={12} strokeWidth={2} color="#dc2626" />{error}</div>}
